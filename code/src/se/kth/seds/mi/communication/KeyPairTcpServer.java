 ...
 */
public class KeyPairTcpServer implements Server {
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        logger.info("received PublicKey: " + publicKey);
                        KeyPairReceiverFrame receiverFrame = (KeyPairReceiverFrame) frame;
                        receiverFrame.setMessage(messageWithMac.getMessage());
                        receiverFrame.setSignature(messageWithMac.getMac());
                        receiverFrame.setReceivedPublicKey(publicKey);
                    } catch (IOException e) {
